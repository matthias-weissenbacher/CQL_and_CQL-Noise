...
class CQL(object):
    def __init__(self,env, num_inputs, action_space,  args,device=device ):
    ...
    def update_parameters(self, batch, updates):
        ...
        with torch.no_grad():
            ...
            qf1_next_target, qf2_next_target = self.critic_target(self.state_noise(next_state_batch), next_state_action)
        ...
        qf1_pred, qf2_pred = self.critic(self.state_noise(state_batch), action_batch)  # Two Q-functions to mitigate positive bias in the policy improvement step
